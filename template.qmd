...
From my analysis, it appears that there is no noticable correlation between the height of elevating my house to gaining benefit. In fact, all the NPVs that I've calculated are negative. However, it seems that elevating the house to 9 feet is the best case scenario with an NPV of -127245, and the worst case scenario is elevating the house to 6 feet. 
